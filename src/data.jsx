...
const OESDATA = (() => {
  ...
  /* — Мои решения —
     kind: 'dash' | 'alert' | 'command' (агенты и автоматизации объединены в «команды»)
     shortId — уникальный 8-символьный id, показывается в режиме просмотра/редактирования
     enabled — вкл/выкл (столбец «Актив.»); published — опубликовано / черновик */
  const solutions = [
    {
      id: 'sol-01', shortId: '4ab15032', name: 'Объём вскрыши — экскаваторы КТ', kind: 'dash',
      ...
      status: 'active', enabled: true, shared: false, published: true,
      forks: 0, rating: null,
      author: 'Степанов А. В.', authorInitials: 'СА',
    },
    {
      id: 'sol-02', shortId: '4e114573', name: 'Просадки КИО за ночную смену', kind: 'alert',
      ...
      status: 'active', enabled: true, shared: true, published: true,
      forks: 8, rating: 4.6,
      author: 'Дьяконов И. К.', authorInitials: 'ДИ',
    },
    {
      id: 'sol-03', shortId: '4eea32dd', name: 'Утренний дайджест по парку', kind: 'command',
      ...
      status: 'active', enabled: false, shared: false, published: true,
      forks: 0, rating: null,
      author: 'Фаризунов Р. С.', authorInitials: 'ФР',
    },
    {
      id: 'sol-04', shortId: '7c1908a4', name: 'Цикл погрузки — почасовой рейтинг', kind: 'dash',
    ...
    {
      id: 'sol-05', shortId: '9f3b2e10', name: 'Q&A агент по справочнику ТО', kind: 'command',
    ...
    {
      id: 'sol-06', shortId: 'b2d40c77', name: 'Бюджет — добыча и вскрыша', kind: 'dash',
    ...
    {
      id: 'sol-07', shortId: 'a17e6f29', name: 'Балансировщик звеньев — превью', kind: 'dash',
      ...
      status: 'draft', enabled: false, shared: false, published: false,
      forks: 0, rating: null,
      author: 'Фаризунов Р. С.', authorInitials: 'ФР',
    },
    {
      id: 'sol-08', shortId: 'c44d9b03', name: 'Монитор потерь', kind: 'dash',
  ...
  /* — Ассистент пользователя: контейнер + агенты (для вкладки «Профиль») — */
  const assistant = {
    container: {
      status: 'Running',
      dockerId: 'd2cfe0c7f3f1cb5565766d550e1f7a2b3c4d5e6f',
    ...
    mcp: [
      { name: 'Информация об оценке смены', url: 'https://shift-rating-mcp.oeswork.io/mcp' },
    ],
  };
