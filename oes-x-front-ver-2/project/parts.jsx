...
const CHIP_KIND = {
  ...
  agent:   { background: 'rgba(106,158,184,0.12)', color: 'var(--info)',        border: '0.5px solid rgba(106,158,184,0.30)' },
  automation: { background: 'rgba(200,160,64,0.12)', color: 'var(--warn)',      border: '0.5px solid rgba(200,160,64,0.30)' },
...
const CHIP_DOT = {
  ...
  app: 'var(--chip-app-fg)', agent: 'var(--info)', automation: 'var(--warn)', draft: 'var(--fg-muted)',
};
...
const KIND_CHIP_LABEL = {
  dash: 'ДАШБОРД', alert: 'АЛЕРТ', agent: 'АГЕНТ', automation: 'АВТОМАТИЗАЦИЯ', app: 'ПРИЛОЖЕНИЕ', draft: 'ЧЕРНОВИК',
};
const KIND_CHIP_KIND = {
  dash: 'dash', alert: 'alert', agent: 'agent', automation: 'automation', app: 'app', draft: 'draft',
};
...
Object.assign(window, { Chip, KindChip, Kpi, Sparkline, MiniBars, ActivityIcon, SourceKind, PreviewChartLine, PreviewChartBars, ForecastChart });
