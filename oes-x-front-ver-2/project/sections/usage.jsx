    ...
    <div className="main-narrow fade-up">
      <div className="page-head">
        <div>
          ...
          <div className="page-sub">Период: {b.period} · до конца — {b.daysInPeriod - todayDay} дней · роль «{OESDATA.me.role}» · пресет «medium»</div>
        </div>
        <div style={{ display: 'flex', gap: 8 }}>
          <button className="btn btn-neutral"><IconDownload size={11} /> Отчёт CSV</button>
          <button className="btn btn-warn"><IconMail size={11} /> Запросить повышение лимита</button>
        </div>
      </div>

      <LimitBanner state={'normal'} setRoute={setRoute} />
...
Object.assign(window, { SectionUsage });
