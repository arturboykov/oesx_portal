...
function SectionSolutionView({ solution, setRoute, openEdit, editInChat }) {
  ...
  return (
    <div className="fade-up">
      <SolutionHeader sol={sol} version={solution.version} historic={isHistoricVersion} setRoute={setRoute} openEdit={openEdit} editInChat={editInChat} canEdit={canEdit} isOwner={isOwner} />
...
function SolutionHeader({ sol, version, historic, setRoute, openEdit, editInChat, canEdit, isOwner }) {
  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 14 }}>
        ...
        <button className="btn btn-neutral btn-sm" onClick={handleShare} data-comment-anchor="65f0f94b9e-button-60-9"><IconShare size={11} /> Поделиться</button>
        {canEdit ?
        historic ?
        ...
        <button className="btn btn-ghost btn-sm" onClick={handleEdit} data-comment-anchor="4cef41b8ec-button-67-13" title="Открыть в чате и описать правки">
...
Object.assign(window, { SectionSolutionView, DashBudget, DashVolumePerShift, DashCycleRating, DashLossesMonitor });